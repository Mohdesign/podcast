class EpisodesController < ApplicationController
	...
	before_action :require_permisson
	...
	def show
		# same line of code from podcast cntroller under show method
		# reject added to remove the first in the loop realted episode because it is in the show page itslef
	...
	#only the current user allow to access to his podcast
